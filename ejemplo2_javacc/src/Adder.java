/* Generated By:JavaCC: Do not edit this line. Adder.java */
  ...
  final public Integer X(Adder letras) throws ParseException {
    ...
    numero1 = T(letras);
    resultado = XP(letras, numero1);
                                                     {if (true) return resultado;}
    throw new Error("Missing return statement in function");
  }

  final public Integer XP(Adder letras, Integer sum) throws ParseException {
                                       Integer numero1, resultado;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case MAS:
      jj_consume_token(MAS);
      numero1 = T(letras);
      resultado = XP(letras, sum+numero1);
                                                               {if (true) return resultado;}
      break;
    case MENOS:
  ...
  final public Integer F(Adder letras) throws ParseException {
                         Token numero;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NUMBER:
